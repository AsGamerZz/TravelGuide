...
import 'package:travel_guide/authentication/login.dart';
import 'package:travel_guide/splash_screen/splash_screen.dart';
...
class _SignupPageState extends State<SignupPage> {
  ...
  saveCustomerInfo() async {
    ...
    if (firebaseUser != null) {
      ...
      DatabaseReference customerRef = fdb.ref().child("customers");
